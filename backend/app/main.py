...
# CORS enabled for production Render and local development
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://devclash-vanarsena-1.onrender.com",
        "http://localhost:3000",
        "http://localhost:5173",
        "http://localhost:5174",
        "http://127.0.0.1:5173",
    ...
    allow_origin_regex=r"https?://(localhost|127\.0\.0\.1|devclash-vanarsena-1\.onrender\.com)(:\d+)?$",
